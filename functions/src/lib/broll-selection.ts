// TWIN COPY of lib/split-reel/broll-selection.ts. functions/ cannot import lib/;
// keep the two in sync. Both pure. The single test lives in __tests__/split-reel/.
