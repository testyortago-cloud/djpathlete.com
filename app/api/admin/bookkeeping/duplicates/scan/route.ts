...
const SYSTEM_PROMPT = [
  ...
  "(classic cases: a scanned receipt AND a bank-statement import of the same purchase; the same statement imported twice;",
  "or a vendor's emailed INVOICE and its paid RECEIPT for the same charge — one document says 'amount due', the other 'paid', but they are one transaction).",
