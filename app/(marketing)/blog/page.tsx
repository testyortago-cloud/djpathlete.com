...
export const metadata: Metadata = {
  title: "Blog",
  description: "Insights on performance, coaching, recovery, and athletic development from Darren J Paul.",
  openGraph: {
      ...
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-24 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <p className="text-sm font-medium text-accent uppercase tracking-widest">Blog</p>
            <div className="h-px w-8 bg-accent" />
          </div>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Practical perspectives from two decades of working with athletes at every level. No fluff, no fads — just
            what works.
          </p>
        </div>
      </section>
        ...
        <FadeIn>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              If these ideas resonate, imagine what a personalized coaching relationship could do for your performance.
            </p>
            <Link
              href="/contact"
