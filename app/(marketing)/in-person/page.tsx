        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            <div className="text-center mb-10">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div className="h-px w-8 bg-accent" />
                <p className="text-sm font-medium text-accent uppercase tracking-widest">Tampa Bay Service Area</p>
                <div className="h-px w-8 bg-accent" />
              </div>
              <h2
          ...
          <FadeIn delay={0.15}>
            <p className="mt-8 text-center text-sm text-muted-foreground max-w-2xl mx-auto">
              Drive times are approximate from city center. Coaching is by application — sessions scheduled around
              athlete availability and capacity at the facility.
            </p>
          </FadeIn>
        </div>
      </section>
