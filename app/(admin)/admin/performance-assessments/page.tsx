...
import { getAllPerformanceAssessments, getPerformanceAssessmentCounts } from "@/lib/db/performance-assessments"
...
export default async function AdminPerformanceAssessmentsPage() {
  ...
  try {
    ;[assessments, counts] = await Promise.all([getAllPerformanceAssessments(), getPerformanceAssessmentCounts()])
  } catch {
