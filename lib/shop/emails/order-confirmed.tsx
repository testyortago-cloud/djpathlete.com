...
export function OrderConfirmedEmail({ order, lookupUrl }: Props) {
  return (
    <html lang="en">
      <head>
        <meta charSet="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Order in Production — DJP Athlete</title>
      </head>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style={{ padding: "44px 48px 52px" }}>
                        ...
                        >
                          Great news &mdash; your order has been confirmed and sent to our
                          production partner. We&rsquo;ll email you again as soon as it ships with
