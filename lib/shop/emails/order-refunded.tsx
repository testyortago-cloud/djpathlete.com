...
export function OrderRefundedEmail({ order, lookupUrl }: Props) {
  const refundAmount = order.refund_amount_cents
    ? `$${(order.refund_amount_cents / 100).toFixed(2)}`
    : `$${(order.total_cents / 100).toFixed(2)}`

  const isPartial =
    order.refund_amount_cents != null && order.refund_amount_cents < order.total_cents
  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Refund Processed — DJP Athlete</title>
      </head>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style={{ padding: "44px 48px 52px" }}>
                        ...
                        >
                          {isPartial ? (
                            <>
                              ...
                              processed for order {order.order_number}. It will appear on your
                              original payment method within 5&ndash;10 business days.
                            </>
                          ) : (
                            <>
                              A full refund of{" "}
                        ...
                        >
                          If you have any questions about your refund, please reply to this email.
                        </p>
