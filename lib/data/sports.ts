...
export const SPORTS: Sport[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Golf performance training built around rotation, anti-rotation and ground reaction force. Tampa Bay and online, by Darren J Paul, PhD (CSCS, NASM).",
