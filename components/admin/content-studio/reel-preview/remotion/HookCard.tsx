// components/admin/content-studio/reel-preview/remotion/HookCard.tsx
// TWIN COPY of render-worker/src/remotion/HookCard.tsx for the in-app <Player>
// preview. loadFont() (Lexend Exa 800) is the SAME @remotion/google-fonts loader
// the worker uses (requires fonts.gstatic.com in CSP font-src). Keep in sync.
