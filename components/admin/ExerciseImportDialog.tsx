...
export function ExerciseImportDialog({ open, onOpenChange }: ExerciseImportDialogProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a CSV file with columns: name, description, category, difficulty, muscle_group, equipment,
            instructions, is_bodyweight, training_intent, difficulty_max, video_url. Training intent values: Build,
            Shape, Express (use pipe or slash to separate multiple, e.g. &ldquo;Build/Shape&rdquo;). AI metadata
            (movement_pattern, primary/secondary muscles, force_type, laterality, equipment_required) can be generated
        ...
        {previewRows.length === 0 ? (
          <div className="flex flex-col items-center gap-4 py-8">
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-4">Select a CSV file to preview and import exercises.</p>
