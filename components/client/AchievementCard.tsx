  ...
  return (
    ...
    >
      <div className="flex items-start gap-2.5 sm:gap-3">
        <div className={`flex shrink-0 items-center justify-center size-9 sm:size-10 rounded-full ${iconBg}`}>
          <Icon className={`size-4 sm:size-5 ${iconColor}`} strokeWidth={1.5} />
        </div>
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            <h3 className="text-xs sm:text-sm font-semibold text-foreground leading-snug">{achievement.title}</h3>
