 ...
 * Colors come from the `.athlete-arena` variable scope.
 */
export function AthleteRadarSection({ tests }: { tests: RadarTestPoint[] }) {
  ...
  return (
    <section aria-label="Athlete radar" className="mt-14">
      <SectionHeading>Athlete Radar</SectionHeading>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart data={data} margin={{ top: 12, right: 24, bottom: 12, left: 24 }}>
              ...
              <Radar
                ...
                fill="var(--accent)"
                fillOpacity={0.22}
                dot={{ r: 2.5, fill: "var(--accent)", fillOpacity: 1, strokeWidth: 0 }}
              />
            </RadarChart>
          </ResponsiveContainer>
        </div>
