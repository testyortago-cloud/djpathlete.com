...
interface StepUpInquiryFormClientProps {
  /**
   * The SMS opt-in sentence, already rendered server-side by the
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      {/* SMS opt-in checkbox, under the phone field, UNCHECKED by default.
          `smsConsentWording` is undefined whenever the `StepUpInquiryForm`
          server wrapper found no usable business name to fetch. */}
      {smsConsentWording ? (
        <label
          htmlFor="sufs-sms-consent"
