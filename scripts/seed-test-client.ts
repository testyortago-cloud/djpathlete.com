...
function clientId(n: number) {
  return `20000000-0000-0000-0000-0000000000${String(n).padStart(2, "0")}`
}
function programId(n: number) {
  return `20000000-0000-0000-0000-0000000001${String(n).padStart(2, "0")}`
}
function assignmentId(n: number) {
  return `20000000-0000-0000-0000-0000000002${String(n).padStart(2, "0")}`
}
function assessmentId(n: number) {
  return `20000000-0000-0000-0000-0000000003${String(n).padStart(2, "0")}`
}
...
const clients: ClientDef[] = [
  {
    ...
    goals:
      "Goals: muscle_gain, sport_specific | Likes: compound lifts, explosive movements | Dislikes: long-distance cardio",
    injuries: "Minor right ankle sprain history",
    height_cm: 185,
    weight_kg: 82,
    weight_unit: "kg",
    emergency_name: "Jordan Turner",
    emergency_phone: "+61 400 999 001",
    equipment: [
      "barbell",
      "dumbbells",
      "squat_rack",
    ...
    exercise_likes: "Squats, bench, jumps",
    exercise_dislikes: "Long runs",
    training_background: "4 years gym, 8 years basketball",
    additional_notes: "Improve vertical jump",
    program_name: "Upper / Lower Power & Hypertrophy",
    program_desc: "4-day upper/lower split blending strength and hypertrophy.",
    program_category: ["strength", "sport_specific"],
    program_difficulty: "intermediate",
    program_weeks: 4,
    program_sessions: 4,
    program_split: "upper_lower",
    program_periodization: "undulating",
    assessment_levels: {
  ...
  },
  {
    ...
    weight_kg: 66,
    weight_unit: "kg",
    emergency_name: "Wei Chen",
    emergency_phone: "+61 400 999 002",
    ...
    movement_confidence: "learning",
    exercise_likes: "Lunges, planks, jumps",
    exercise_dislikes: "Heavy deadlifts",
    training_background: "1 year casual gym, plays volleyball recreationally",
    additional_notes: "Wants to jump higher and prevent knee injuries",
    program_name: "Bodyweight Foundations",
    program_desc: "3-day beginner program focused on movement quality and bodyweight strength.",
    program_category: ["strength", "recovery"],
    program_difficulty: "beginner",
    program_weeks: 6,
    program_sessions: 3,
    program_split: "full_body",
    program_periodization: "linear",
    assessment_levels: {
      overall: "beginner",
      squat: "beginner",
      push: "beginner",
  ...
  },
  {
    ...
    weight_kg: 95,
    weight_unit: "kg",
    emergency_name: "Fiona O'Brien",
    emergency_phone: "+61 400 999 003",
    ...
    injury_details: [
      {
        ...
        side: "bilateral",
        severity: "mild",
        notes: "Tightness after heavy pulls — manages with mobility",
      },
    ],
    training_years: 8,
    sleep_hours: "7",
    ...
    movement_confidence: "proficient",
    exercise_likes: "Squat, bench, deadlift",
    exercise_dislikes: "Running, machines",
    training_background: "8 years powerlifting, competed at state level",
    additional_notes: "Prepping for next comp in 12 weeks",
    program_name: "Powerlifting Peaking Block",
    program_desc: "5-day competition prep focusing on SBD specificity with accessory work.",
    program_category: ["strength"],
    program_difficulty: "advanced",
    program_weeks: 8,
    program_sessions: 5,
    program_split: "push_pull_legs",
    program_periodization: "block",
    assessment_levels: {
      overall: "advanced",
      squat: "advanced",
      push: "advanced",
  ...
  },
  {
    ...
    weight_kg: 62,
    weight_unit: "kg",
    emergency_name: "Raj Patel",
    emergency_phone: "+61 400 999 004",
    equipment: ["dumbbells", "cable_machine", "pull_up_bar", "bands", "medicine_ball", "bench"],
    session_minutes: 50,
    training_days: 4,
    injury_details: [
      { area: "shoulder", side: "right", severity: "moderate", notes: "Impingement — avoid heavy overhead pressing" },
    ],
    training_years: 3,
    sleep_hours: "7",
    stress_level: "moderate",
    occupation_activity: "light",
    movement_confidence: "comfortable",
    exercise_likes: "Rows, lat pulldowns, core",
    exercise_dislikes: "Heavy overhead press",
    training_background: "3 years gym, competitive swimmer since age 10",
    additional_notes: "Focus on shoulder health and pull power",
    program_name: "Swim-Specific Strength",
    program_desc: "4-day program emphasizing pull strength, core stability, and shoulder prehab.",
    program_category: ["strength", "sport_specific"],
    program_difficulty: "intermediate",
    program_weeks: 6,
    program_sessions: 4,
  ...
  },
  {
    ...
    weight_kg: 105,
    weight_unit: "kg",
    emergency_name: "Sarah Williams",
    emergency_phone: "+61 400 999 005",
    equipment: [
      "barbell",
      "dumbbells",
      "squat_rack",
    ...
    sleep_hours: "8_plus",
    stress_level: "low",
    occupation_activity: "heavy",
    movement_confidence: "expert",
    exercise_likes: "All compound and explosive lifts",
    exercise_dislikes: "None",
    training_background: "10 years serious training, semi-pro rugby league",
    additional_notes: "In-season — manage fatigue alongside games",
    program_name: "In-Season Rugby Power",
    program_desc: "5-day in-season program balancing match recovery with power and speed maintenance.",
    program_category: ["strength", "sport_specific", "conditioning"],
    program_difficulty: "advanced",
    program_weeks: 4,
    program_sessions: 5,
    program_split: "upper_lower",
  ...
  },
  {
    ...
    weight_kg: 72,
    weight_unit: "kg",
    emergency_name: "David Kim",
    emergency_phone: "+61 400 999 006",
    ...
    occupation_activity: "moderate",
    movement_confidence: "learning",
    exercise_likes: "Lunges, glute bridges, box jumps",
    exercise_dislikes: "Bench press, pull-ups",
    training_background: "No gym experience, plays club netball",
    additional_notes: "First time training — needs confidence building",
    program_name: "First Steps: Movement Mastery",
    program_desc: "3-day beginner program teaching fundamental movement patterns with light loads.",
    program_category: ["strength", "recovery"],
    program_difficulty: "beginner",
    program_weeks: 8,
    program_sessions: 3,
  ...
  },
  {
    ...
    injuries: "Left IT band tightness",
    height_cm: 178,
    weight_kg: 74,
    weight_unit: "kg",
    emergency_name: "Amy Brooks",
    emergency_phone: "+61 400 999 007",
    ...
    occupation_activity: "sedentary",
    movement_confidence: "comfortable",
    exercise_likes: "Kettlebells, circuits, planks",
    exercise_dislikes: "Max effort barbell",
    training_background: "5 years endurance sports, minimal strength work",
    additional_notes: "Wants to add strength without gaining mass",
    program_name: "Endurance Athlete Strength",
    program_desc: "3-day supplemental strength program for endurance athletes — low volume, high impact.",
    program_category: ["strength", "conditioning"],
    program_difficulty: "intermediate",
    program_weeks: 6,
    program_sessions: 3,
    program_split: "full_body",
  ...
  },
  {
    ...
    injuries: "Previous left wrist sprain",
    height_cm: 163,
    weight_kg: 60,
    weight_unit: "kg",
    emergency_name: "Carlos Martinez",
    emergency_phone: "+61 400 999 008",
    equipment: [
      "barbell",
      "dumbbells",
      "squat_rack",
    ...
    training_days: 5,
    injury_details: [
      { area: "wrist", side: "left", severity: "mild", notes: "Old sprain — wrap for heavy front rack" },
    ],
    training_years: 6,
    sleep_hours: "8_plus",
    stress_level: "low",
    occupation_activity: "moderate",
    movement_confidence: "proficient",
    exercise_likes: "Squats, pull-ups, KB swings",
    exercise_dislikes: "Machine-only work",
    training_background: "6 years CrossFit, competed at regional level",
    additional_notes: "Training for CrossFit Open",
    program_name: "CrossFit Competition Prep",
    program_desc: "5-day hybrid strength & metabolic conditioning for competitive CrossFit.",
    program_category: ["strength", "conditioning", "sport_specific"],
    program_difficulty: "advanced",
    program_weeks: 6,
    program_sessions: 5,
    program_split: "push_pull_legs",
  ...
  },
  {
    ...
    injuries: "Chronic lower back pain",
    height_cm: 182,
    weight_kg: 88,
    weight_unit: "kg",
    emergency_name: "Claire Foster",
    emergency_phone: "+61 400 999 009",
    equipment: ["dumbbells", "cable_machine", "bands", "yoga_mat", "foam_roller"],
    session_minutes: 40,
    training_days: 3,
    injury_details: [
      { area: "lower_back", side: "bilateral", severity: "moderate", notes: "Chronic — avoid loaded spinal flexion" },
    ],
    training_years: 1,
    sleep_hours: "6",
    stress_level: "high",
    occupation_activity: "sedentary",
    movement_confidence: "learning",
    exercise_likes: "Rotational work, stretching",
    exercise_dislikes: "Deadlifts, heavy squats",
    training_background: "1 year casual gym, plays golf 3x/week",
    additional_notes: "Focus on rotational power and back pain management",
    program_name: "Golf Performance & Mobility",
    program_desc: "3-day program for rotational power, core stability, and mobility for golfers.",
    program_category: ["strength", "recovery", "sport_specific"],
    program_difficulty: "beginner",
    program_weeks: 8,
    program_sessions: 3,
    program_split: "full_body",
  ...
  },
  {
    ...
    injuries: "Right hamstring strain (recovered)",
    height_cm: 168,
    weight_kg: 58,
    weight_unit: "kg",
    emergency_name: "Omar Hassan",
    emergency_phone: "+61 400 999 010",
    ...
    injury_details: [
      {
        ...
        side: "right",
        severity: "mild",
        notes: "Grade 1 strain 6 months ago — cleared to train, extra warm-up",
      },
    ],
    training_years: 5,
    sleep_hours: "8_plus",
    ...
    occupation_activity: "light",
    movement_confidence: "comfortable",
    exercise_likes: "Hip thrusts, box jumps, RDLs",
    exercise_dislikes: "Long slow runs",
    training_background: "5 years track, 3 years gym",
    additional_notes: "Preparing for nationals — focus on speed and power",
    program_name: "Sprint Power Development",
    program_desc: "4-day program for 400m sprinters — explosive strength, hip power, and speed work.",
    program_category: ["strength", "sport_specific"],
    program_difficulty: "intermediate",
    program_weeks: 6,
    program_sessions: 4,
