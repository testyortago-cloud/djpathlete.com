...
describe("isPlatformPostTypeSupported", () => {
  ...
  it("accepts linkedin + carousel (new in Phase 2c)", () => {
    expect(isPlatformPostTypeSupported("linkedin", "carousel")).toBe(true)
  })

  it("rejects carousel on tiktok (pending Phase 2d)", () => {
